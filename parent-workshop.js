    ...
    try {
      await pool.query(`
        CREATE TABLE IF NOT EXISTS parent_workshops (
          ...
          mode ENUM('in-person','virtual','hybrid') NOT NULL DEFAULT 'in-person',
          status ENUM('draft','published','registration-open','in-progress','completed','cancelled') NOT NULL DEFAULT 'draft',
      ...
      await pool.query(`
        CREATE TABLE IF NOT EXISTS workshop_registrations (
          ...
          feedback_score TINYINT DEFAULT NULL COMMENT '1-5',
          feedback_comment TEXT,
          certificate_issued TINYINT(1) DEFAULT 0,
          certificate_issued_at TIMESTAMP NULL,
          UNIQUE KEY uk_workshop_parent (workshop_id, parent_id),
          INDEX idx_tenant (tenant_id),
