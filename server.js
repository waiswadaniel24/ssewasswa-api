...
function renderPage(title, content, user, isPublic, lang) {
  ...
  let nav = '';
  if (user && !isPublic) {
    nav = '<div style="background:linear-gradient(135deg,#1e40af,#3b82f6);color:white;padding:10px 20px;display:flex;justify-content:space-between;align-items:center;margin:0 0 24px 0;flex-wrap:wrap"><div style="font-weight:700;font-size:18px">' + esc(user.tenant_name || 'SSEWASSWA') + '</div><div style="display:flex;gap:6px;flex-wrap:wrap;font-size:12px"><a href="/" style="color:white;text-decoration:none">=���</a><a href="/app" style="color:white;text-decoration:none">=���</a><a href="/app/students" style="color:white;text-decoration:none">=���</a><a href="/app/fees" style="color:white;text-decoration:none">=�Ʀ</a><a href="/app/attendance" style="color:white;text-decoration:none">G��</a><a href="/app/grades" style="color:white;text-decoration:none">=���</a><a href="/app/analytics" style="color:white;text-decoration:none">=���</a><a href="/learning" style="color:white;text-decoration:none">=���</a><a href="/learning/live" style="color:white;text-decoration:none">=���</a><a href="/store" style="color:white;text-decoration:none">=���</a><a href="/marketplace" style="color:white;text-decoration:none">=�Ŭ</a><a href="/videos" style="color:white;text-decoration:none">=�ļ</a><a href="/games" style="color:white;text-decoration:none">=�ī</a><a href="/news" style="color:white;text-decoration:none">=���</a><a href="/bonus" style="color:white;text-decoration:none">=���</a><a href="/app/referrals" style="color:white;text-decoration:none">=�Ʀ</a><a href="/premium" style="color:white;text-decoration:none">G��</a><a href="/app/settings" style="color:white;text-decoration:none">G��n+�</a><a href="/logout" style="color:white;text-decoration:none">=�ܬ</a></div></div>';
  } else if (isPublic) {
    nav = '<div style="background:linear-gradient(135deg,#1e40af,#3b82f6);color:white;padding:10px 20px;display:flex;justify-content:space-between;align-items:center;margin:0 0 24px 0;flex-wrap:wrap"><div style="font-weight:700;font-size:18px">SSEWASSWA</div><div style="display:flex;gap:6px;flex-wrap:wrap;font-size:12px"><a href="/" style="color:white;text-decoration:none">=���</a><a href="/learning" style="color:white;text-decoration:none">=���</a><a href="/store" style="color:white;text-decoration:none">=���</a><a href="/marketplace" style="color:white;text-decoration:none">=�Ŭ</a><a href="/videos" style="color:white;text-decoration:none">=�ļ</a><a href="/games" style="color:white;text-decoration:none">=�ī</a><a href="/news" style="color:white;text-decoration:none">=���</a><a href="/premium" style="color:white;text-decoration:none">G��</a><a href="/login" style="color:white;text-decoration:none">=���</a><a href="/demo" style="color:white;text-decoration:none">=��P</a></div></div>';
  }
...
app.get('/', ah(async (req, res) => {
  ...
  res.send(renderPage('SSEWASSWA', '<div class="hero"><h1>Learn - Shop - Play - Earn</h1><div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap"><a href="/signup" class="btn btn-green" style="font-size:18px;padding:16px 32px">Get Started</a><a href="/demo" class="btn btn-gold" style="font-size:18px;padding:16px 32px">=��P Book Demo</a></div></div><div class="stats"><div class="stat-card"><div class="stat-num">50K+</div><div>Users</div></div><div class="stat-card"><div class="stat-num">500+</div><div>Schools</div></div><div class="stat-card"><div class="stat-num">10M+</div><div>Rewards</div></div></div><div class="grid"><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/learning\'"><div style="font-size:48px">=���</div><h3>Learning</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/store\'"><div style="font-size:48px">=���</div><h3>Store</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/marketplace\'"><div style="font-size:48px">=�Ŭ</div><h3>Marketplace</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/videos\'"><div style="font-size:48px">=�ļ</div><h3>Videos</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/games\'"><div style="font-size:48px">=�ī</div><h3>Games</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/learning/live\'"><div style="font-size:48px">=���</div><h3>Live Classes</h3></div></div><div class="card"><h2>Latest News</h2><div class="grid">' + news + '</div></div>', null, true));
}));
...
app.get('/bonus', requireAuth, checkDb, ah(async (req, res) => {
  ...
  res.send(renderPage('Rewards', '<div class="hero" style="padding:40px 20px"><h2>My Wallet</h2><div class="stat-num" style="font-size:48px;color:white;-webkit-text-fill-color:white">UGX ' + w.balance + '</div><div style="display:flex;gap:12px;justify-content:center;margin-top:20px"><a href="/bonus/withdraw" class="btn btn-green">Withdraw</a><a href="/bonus/affiliate" class="btn btn-purple">Affiliate</a></div></div><div class="grid"><div class="stat-card" onclick="location.href=\'/videos\'" style="cursor:pointer"><div style="font-size:36px">=�ļ</div><div>Videos +50</div></div><div class="stat-card" onclick="location.href=\'/news\'" style="cursor:pointer"><div style="font-size:36px">=���</div><div>News +20</div></div><div class="stat-card" onclick="location.href=\'/downloads\'" style="cursor:pointer"><div style="font-size:36px">=���</div><div>Downloads +100</div></div><div class="stat-card" onclick="location.href=\'/games\'" style="cursor:pointer"><div style="font-size:36px">=�ī</div><div>Games +30</div></div></div><div class="card"><h3>Recent</h3><table><thead><tr><th>Date</th><th>Type</th><th>Amount</th></tr></thead><tbody>' + (rows || '<tr><td colspan="3">None yet</td></tr>') + '</tbody></table></div>', { tenant_name: req.tenant.name }, false, req.lang));
}));
...
app.get('/learning/live', requireAuth, checkDb, ah(async (req, res) => {
  ...
  res.send(renderPage('Live Classes', '<div class="hero" style="padding:30px"><h1>Live Classes</h1>' + (['teacher', 'admin', 'super_admin'].includes(req.session.user.role) ? '<a href="/learning/live/create" class="btn btn-green" style="margin-top:12px">Create</a>' : '') + '</div><div class="grid">' + (c.rows.map(cl => '<div class="card"><div class="badge badge-blue" style="margin-bottom:8px">' + new Date(cl.scheduled_at).toLocaleDateString() + '</div><h3>' + esc(cl.title) + '</h3><p>' + esc(cl.subject) + ' - ' + esc(cl.class) + '</p><p>=��G��=�Ž ' + esc(cl.teacher_name) + ' | =��� ' + cl.students + '</p><div class="stat-num" style="font-size:20px;margin:12px 0">UGX ' + cl.price + '</div><a href="/learning/live/join/' + cl.id + '" class="btn btn-green" style="width:100%">Join</a></div>').join('') || '<div class="card"><p>No classes</p></div>') + '</div>', { tenant_name: req.tenant.name }, false, req.lang));
}));
...
app.post('/demo', checkDb, ah(async (req, res) => {
  ...
  try {
    ...
    await sendWhatsApp(req.body.phone, 'G�� ' + req.body.school_name + ' is LIVE!\nTeacher Code: *' + code + '*\nLink: https://' + req.headers.host + '/school/' + sub);
...
app.post('/super-admin/broadcast', requireAuth, requireRole('super_admin'), checkDb, ah(async (req, res) => {
  ...
  res.send(renderPage('Sent', '<div class="card"><h1>G�� Sent to ' + sent + '</h1><a href="/super-admin" class="btn">Back</a></div>', { tenant_name: req.tenant.name }));
}));
...
app.get('/debug-login', checkDb, ah(async (req, res) => {
  ...
  try {
    ...
    output += '<p class="badge badge-green">Database connected G��</p>';
  } catch (e) {
  ...
  try {
    ...
    output += '<p>User exists: ' + (user.rows.length > 0 ? 'YES G��' : 'NO G��') + '</p>';
    if (user.rows.length > 0) {
      ...
      output += '<p>Password "admin123" matches: ' + (match ? 'YES G��' : 'NO G��') + '</p>';
    }
  } catch (e) {
  ...
  try {
    ...
    output += '<p>Wallet exists: ' + (wallet.rows.length > 0 ? 'YES G��' : 'NO G��') + '</p>';
    if (wallet.rows[0]) {
...
app.post('/create-site', checkDb, ah(async (req, res) => {
  try {
    ...
    res.send(renderPage('Success', '<div class="card" style="text-align:center"><h1>G�� Created!</h1><p>Code: ' + esc(req.body.signup_code.toUpperCase()) + '</p><a href="/login" class="btn">Login</a></div>', null, true));
...
async function initDB() {
  ...
  while (retries > 0) {
    try {
      ...
      if (process.env.DATABASE_URL) {
        var safeUrl = process.env.DATABASE_URL.replace(/\/\/([^:]+):([^@]+)@/, "//$1:HIDDEN@");
        console.error("URL (masked):", safeUrl);
      }
      console.error("========================");
      dbReady = false;
    }
