...
app.get('/', ah(async (req, res) => {
  ...
  res.send(renderPage('SSEWASSWA', `<div class="hero"><h1>Learn - Shop - Play - Earn</h1><div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap"><a href="/signup" class="btn btn-green" style="font-size:18px;padding:16px 32px">Get Started</a><a href="/demo" class="btn btn-gold" style="font-size:18px;padding:16px 32px">Book Demo</a></div></div><div class="stats"><div class="stat-card"><div class="stat-num">50K+</div><div>Users</div></div><div class="stat-card"><div class="stat-num">500+</div><div>Schools</div></div><div class="stat-card"><div class="stat-num">10M+</div><div>Rewards</div></div></div><div class="grid"><div class="card" style="text-align:center;cursor:pointer" onclick="location.href='/learning'"><div style="font-size:48px">📚</div><h3>Learning</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href='/store'"><div style="font-size:48px">🛒</div><h3>Store</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href='/marketplace'"><div style="font-size:48px">🏪</div><h3>Marketplace</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href='/videos'"><div style="font-size:48px">🎬</div><h3>Videos</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href='/games'"><div style="font-size:48px">🎮</div><h3>Games</h3></div></div><div class="card"><h2>Latest News</h2><div class="grid">${news}</div></div>`, null, true));
}));
