...
function renderPage(title, content, user, isPublic, lang) {
  ...
  let nav = '';
  if (user && !isPublic) {
    nav = '<div style="background:linear-gradient(135deg,#1e40af,#3b82f6);color:white;padding:10px 20px;display:flex;justify-content:space-between;align-items:center;margin:0 0 24px 0;flex-wrap:wrap"><div style="font-weight:700;font-size:18px">' + esc(user.tenant_name || 'SSEWASSWA') + '</div><div style="display:flex;gap:6px;flex-wrap:wrap;font-size:12px"><a href="/" style="color:white;text-decoration:none">=ƒÅá</a><a href="/app" style="color:white;text-decoration:none">=ƒôè</a><a href="/app/students" style="color:white;text-decoration:none">=ƒÄô</a><a href="/app/fees" style="color:white;text-decoration:none">=ƒÆ¦</a><a href="/app/attendance" style="color:white;text-decoration:none">G£à</a><a href="/app/grades" style="color:white;text-decoration:none">=ƒô¥</a><a href="/app/analytics" style="color:white;text-decoration:none">=ƒôê</a><a href="/learning" style="color:white;text-decoration:none">=ƒôÜ</a><a href="/learning/live" style="color:white;text-decoration:none">=ƒÄÑ</a><a href="/store" style="color:white;text-decoration:none">=ƒ¢Æ</a><a href="/marketplace" style="color:white;text-decoration:none">=ƒÅ¬</a><a href="/videos" style="color:white;text-decoration:none">=ƒÄ¼</a><a href="/games" style="color:white;text-decoration:none">=ƒÄ«</a><a href="/news" style="color:white;text-decoration:none">=ƒô¦</a><a href="/bonus" style="color:white;text-decoration:none">=ƒÄü</a><a href="/app/referrals" style="color:white;text-decoration:none">=ƒÆ¦</a><a href="/premium" style="color:white;text-decoration:none">G¡É</a><a href="/app/settings" style="color:white;text-decoration:none">GÜÖn+Å</a><a href="/logout" style="color:white;text-decoration:none">=ƒÜ¬</a></div></div>';
  } else if (isPublic) {
    nav = '<div style="background:linear-gradient(135deg,#1e40af,#3b82f6);color:white;padding:10px 20px;display:flex;justify-content:space-between;align-items:center;margin:0 0 24px 0;flex-wrap:wrap"><div style="font-weight:700;font-size:18px">SSEWASSWA</div><div style="display:flex;gap:6px;flex-wrap:wrap;font-size:12px"><a href="/" style="color:white;text-decoration:none">=ƒÅá</a><a href="/learning" style="color:white;text-decoration:none">=ƒôÜ</a><a href="/store" style="color:white;text-decoration:none">=ƒ¢Æ</a><a href="/marketplace" style="color:white;text-decoration:none">=ƒÅ¬</a><a href="/videos" style="color:white;text-decoration:none">=ƒÄ¼</a><a href="/games" style="color:white;text-decoration:none">=ƒÄ«</a><a href="/news" style="color:white;text-decoration:none">=ƒô¦</a><a href="/premium" style="color:white;text-decoration:none">G¡É</a><a href="/login" style="color:white;text-decoration:none">=ƒæñ</a><a href="/demo" style="color:white;text-decoration:none">=ƒôP</a></div></div>';
  }
...
app.post('/api/check-teacher-milestone', requireAuth, checkDb, ah(async (req, res) => {
  ...
  if (cnt >= 10 && !paid) {
    ...
    await sendPushToUser(req.session.user.email, '=ƒÄë Bonus!', 'UGX 5,000 earned!');
...
app.get('/', ah(async (req, res) => {
  ...
  res.send(renderPage('SSEWASSWA', '<div class="hero"><h1>Learn - Shop - Play - Earn</h1><div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap"><a href="/signup" class="btn btn-green" style="font-size:18px;padding:16px 32px">Get Started</a><a href="/demo" class="btn btn-gold" style="font-size:18px;padding:16px 32px">=ƒôP Book Demo</a></div></div><div class="stats"><div class="stat-card"><div class="stat-num">50K+</div><div>Users</div></div><div class="stat-card"><div class="stat-num">500+</div><div>Schools</div></div><div class="stat-card"><div class="stat-num">10M+</div><div>Rewards</div></div></div><div class="grid"><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/learning\'"><div style="font-size:48px">=ƒôÜ</div><h3>Learning</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/store\'"><div style="font-size:48px">=ƒ¢Æ</div><h3>Store</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/marketplace\'"><div style="font-size:48px">=ƒÅ¬</div><h3>Marketplace</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/videos\'"><div style="font-size:48px">=ƒÄ¼</div><h3>Videos</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/games\'"><div style="font-size:48px">=ƒÄ«</div><h3>Games</h3></div><div class="card" style="text-align:center;cursor:pointer" onclick="location.href=\'/learning/live\'"><div style="font-size:48px">=ƒÄÑ</div><h3>Live Classes</h3></div></div><div class="card"><h2>Latest News</h2><div class="grid">' + news + '</div></div>', null, true));
}));

app.get('/login', (req, res) => {
  res.send(renderPage('Login', '<div class="card" style="max-width:450px;margin:40px auto"><div style="text-align:center;margin-bottom:24px"><div style="font-size:60px">=ƒÄô</div><h1>Welcome Back</h1></div><form method="POST" action="/login"><input name="email" placeholder="Email" type="email" required><input name="password" placeholder="Password" type="password" required><button type="submit" class="btn" style="width:100%;font-size:18px;padding:16px">Login</button></form><div style="text-align:center;margin-top:20px"><a href="/signup" style="color:#1e40af">Create Account</a> - <a href="/forgot-password" style="color:#64748b">Forgot?</a></div></div>', null, true));
});
...
app.get('/bonus', requireAuth, checkDb, ah(async (req, res) => {
  ...
  res.send(renderPage('Rewards', '<div class="hero" style="padding:40px 20px"><h2>My Wallet</h2><div class="stat-num" style="font-size:48px;color:white;-webkit-text-fill-color:white">UGX ' + w.balance + '</div><div style="display:flex;gap:12px;justify-content:center;margin-top:20px"><a href="/bonus/withdraw" class="btn btn-green">Withdraw</a><a href="/bonus/affiliate" class="btn btn-purple">Affiliate</a></div></div><div class="grid"><div class="stat-card" onclick="location.href=\'/videos\'" style="cursor:pointer"><div style="font-size:36px">=ƒÄ¼</div><div>Videos +50</div></div><div class="stat-card" onclick="location.href=\'/news\'" style="cursor:pointer"><div style="font-size:36px">=ƒô¦</div><div>News +20</div></div><div class="stat-card" onclick="location.href=\'/downloads\'" style="cursor:pointer"><div style="font-size:36px">=ƒôÑ</div><div>Downloads +100</div></div><div class="stat-card" onclick="location.href=\'/games\'" style="cursor:pointer"><div style="font-size:36px">=ƒÄ«</div><div>Games +30</div></div></div><div class="card"><h3>Recent</h3><table><thead><tr><th>Date</th><th>Type</th><th>Amount</th></tr></thead><tbody>' + (rows || '<tr><td colspan="3">None yet</td></tr>') + '</tbody></table></div>', { tenant_name: req.tenant.name }, false, req.lang));
}));
...
app.get('/downloads', (req, res) => {
  res.send(renderPage('Downloads', '<div class="hero" style="padding:30px"><h1>Downloads</h1></div><div class="grid"><div class="card" style="display:flex;gap:16px;align-items:center"><div style="font-size:48px">=ƒôÜ</div><div style="flex:1"><h4>Khan Academy</h4></div><a href="/bonus/claim/download?url=' + encodeURIComponent('https://play.google.com/store/apps/details?id=org.khanacademy.android') + '&name=Khan" class="btn btn-green">+100</a></div></div>', null, true));
});
...
app.get('/learning', (req, res) => {
  res.send(renderPage('Learning', '<div class="hero" style="padding:30px"><h1>Learn Anything</h1></div><div class="grid"><div class="card" style="text-align:center"><div style="font-size:48px">=ƒöó</div><h3>Mathematics</h3></div><div class="card" style="text-align:center"><div style="font-size:48px">=ƒö¼</div><h3>Science</h3></div><div class="card" style="text-align:center"><div style="font-size:48px">=ƒôû</div><h3>English</h3></div></div>', null, true));
});
...
app.get('/app', requireAuth, checkDb, ah(async (req, res) => {
  ...
  const w = (await pool.query('SELECT balance FROM wallets WHERE user_email=$1', [req.session.user.email])).rows[0] || { balance: 0 };
  res.send(renderPage('Dashboard', '<div class="stats"><div class="stat-card"><div style="font-size:24px;margin-bottom:8px">=ƒÄô</div><div>Students</div><div class="stat-num">' + s.rows[0].c + '</div></div><div class="stat-card"><div style="font-size:24px;margin-bottom:8px">=ƒÆ¦</div><div>Fees</div><div class="stat-num">UGX ' + f.rows[0].t + '</div></div><div class="stat-card"><div style="font-size:24px;margin-bottom:8px">G£à</div><div>Present</div><div class="stat-num">' + a.rows[0].c + '</div></div><div class="stat-card"><div style="font-size:24px;margin-bottom:8px">=ƒÄü</div><div>Rewards</div><div class="stat-num">UGX ' + w.balance + '</div></div></div><div class="card"><h1>Quick Actions</h1><div style="display:flex;gap:12px;flex-wrap:wrap;margin-top:16px"><a href="/app/students/add" class="btn btn-green">Add Student</a><a href="/app/fees/add" class="btn">Record Fee</a><a href="/app/attendance/mark" class="btn">Attendance</a><a href="/app/grades/add" class="btn">Grades</a><a href="/bonus" class="btn btn-purple">Rewards</a></div></div>', { tenant_name: req.tenant.name }, false, req.lang));
}));
...
app.get('/learning/live', requireAuth, checkDb, ah(async (req, res) => {
  ...
  res.send(renderPage('Live Classes', '<div class="hero" style="padding:30px"><h1>Live Classes</h1>' + (['teacher', 'admin', 'super_admin'].includes(req.session.user.role) ? '<a href="/learning/live/create" class="btn btn-green" style="margin-top:12px">Create</a>' : '') + '</div><div class="grid">' + (c.rows.map(cl => '<div class="card"><div class="badge badge-blue" style="margin-bottom:8px">' + new Date(cl.scheduled_at).toLocaleDateString() + '</div><h3>' + esc(cl.title) + '</h3><p>' + esc(cl.subject) + ' - ' + esc(cl.class) + '</p><p>=ƒæ¿GÇì=ƒÅ½ ' + esc(cl.teacher_name) + ' | =ƒæÑ ' + cl.students + '</p><div class="stat-num" style="font-size:20px;margin:12px 0">UGX ' + cl.price + '</div><a href="/learning/live/join/' + cl.id + '" class="btn btn-green" style="width:100%">Join</a></div>').join('') || '<div class="card"><p>No classes</p></div>') + '</div>', { tenant_name: req.tenant.name }, false, req.lang));
}));
...
app.post('/demo', checkDb, ah(async (req, res) => {
  ...
  try {
    ...
    await sendWhatsApp(req.body.phone, 'G£à ' + req.body.school_name + ' is LIVE!\nTeacher Code: *' + code + '*\nLink: https://' + req.headers.host + '/school/' + sub);
    await sendWhatsApp('0789736737', '=ƒöÑ NEW: ' + req.body.school_name + '\nStudents: ' + req.body.students + '\nCode: ' + code);
    res.send(renderPage('Success', '<div class="card" style="text-align:center"><div style="font-size:60px">=ƒÄë</div><h1>' + esc(req.body.school_name) + ' is Live!</h1><p>Code: <strong class="badge badge-gold" style="font-size:24px">' + code + '</strong></p><a href="/demo" class="btn btn-green" style="margin-top:20px">Add Another</a></div>', null, true));
...
app.get('/super-admin', requireAuth, requireRole('super_admin'), checkDb, ah(async (req, res) => {
  ...
  res.send(renderPage('Super Admin', '<div class="hero" style="background:linear-gradient(135deg,#dc2626,#ef4444);padding:30px"><h1>=ƒææ Platform Control</h1></div><div class="stats"><div class="stat-card"><div class="stat-num">UGX ' + r30.toLocaleString() + '</div><div>30 Days</div></div><div class="stat-card"><div class="stat-num">UGX ' + rt.toLocaleString() + '</div><div>Total</div></div><div class="stat-card"><div class="stat-num">UGX ' + w.toLocaleString() + '</div><div>Wallet</div></div><div class="stat-card"><div class="stat-num">' + p.c + '</div><div>Pending (' + Number(p.t).toLocaleString() + ')</div></div><div class="stat-card"><div class="stat-num">' + sc + '</div><div>Schools</div></div><div class="stat-card"><div class="stat-num">' + u + '</div><div>Users</div></div></div><div class="grid"><div class="card"><h3>Actions</h3><div style="display:flex;flex-direction:column;gap:8px;margin-top:12px"><a href="/demo" class="btn btn-green">Create School</a><a href="/super-admin/broadcast" class="btn btn-purple">Broadcast</a><a href="/super-admin/payout-developer" class="btn btn-red">Payout</a></div></div><div class="card"><h3>Auto-Payout</h3><p>Wallet GëÑ UGX 50,000 GåÆ Auto-pays 95% daily</p><p>Cron: GET /api/cron/daily?secret=ssewasswa-cron-2024</p></div></div>', { tenant_name: req.tenant.name }));
}));
...
app.post('/super-admin/broadcast', requireAuth, requireRole('super_admin'), checkDb, ah(async (req, res) => {
  ...
  res.send(renderPage('Sent', '<div class="card"><h1>G£à Sent to ' + sent + '</h1><a href="/super-admin" class="btn">Back</a></div>', { tenant_name: req.tenant.name }));
}));
...
app.get('/debug-login', checkDb, ah(async (req, res) => {
  ...
  try {
    ...
    output += '<p class="badge badge-green">Database connected G£à</p>';
  } catch (e) {
  ...
  try {
    ...
    output += '<p>User exists: ' + (user.rows.length > 0 ? 'YES G£à' : 'NO G¥î') + '</p>';
    if (user.rows.length > 0) {
      ...
      output += '<p>Password "admin123" matches: ' + (match ? 'YES G£à' : 'NO G¥î') + '</p>';
    }
  } catch (e) {
  ...
  try {
    ...
    output += '<p>Wallet exists: ' + (wallet.rows.length > 0 ? 'YES G£à' : 'NO G¥î') + '</p>';
    if (wallet.rows[0]) {
...
app.post('/create-site', checkDb, ah(async (req, res) => {
  try {
    ...
    res.send(renderPage('Success', '<div class="card" style="text-align:center"><h1>G£à Created!</h1><p>Code: ' + esc(req.body.signup_code.toUpperCase()) + '</p><a href="/login" class="btn">Login</a></div>', null, true));
...
app.use((req, res) => { res.status(404).send(renderPage('404', '<div class="card" style="text-align:center"><div style="font-size:64px;margin-bottom:16px">=ƒöì</div><h1>404 Not Found</h1><a href="/" class="btn">Go Home</a></div>', null, true)); });
