    ...
    try {
      await pool.query(`
        CREATE TABLE IF NOT EXISTS bank_accounts (
          ...
          account_type ENUM('checking','savings',' allowances') NOT NULL DEFAULT 'checking',
      ...
      await pool.query(`
        CREATE TABLE IF NOT EXISTS bank_transactions (
          ...
          type ENUM('deposit','withdrawal','transfer_in','transfer_out','interest','fee','adjustment') NOT NULL,
      ...
      await pool.query(`
        CREATE TABLE IF NOT EXISTS bank_budgets (
          ...
          created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
          UNIQUE KEY uk_budget (tenant_id, account_id, category, period_month),
          INDEX idx_tenant (tenant_id)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4
      `);
      await pool.query(`
      ...
      await pool.query(`
        CREATE TABLE IF NOT EXISTS lesson_progress (
          ...
          UNIQUE KEY uk_progress (tenant_id, student_id, lesson_id),
          INDEX idx_tenant (tenant_id)
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4
      `);
